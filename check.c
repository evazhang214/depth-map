...
int main(int argc, char **argv)
{
	...
	if (!testCalcDepthVerbose(100, 100, 4, 4, 14))
	{
		returnResult = -1;
	}

	if (!testCalcDepthVerbose(15, 13, 4, 4, 3))
	{
		returnResult = -1;
	}

	if (!testCalcDepthVerbose(91, 87, 7, 6, 18))
	{
		returnResult = -1;
	}

	if (!testCalcDepthVerbose(97, 59, 4, 4, 55))
	{
		returnResult = -1;
	}

	if (!testCalcDepthVerbose(66, 43, 4, 3, 14))
	{
		returnResult = -1;
	}
	...
	if (!testCalcDepthVerbose(47, 29, 5, 2, 2))
	{
		returnResult = -1;
	}
